...
using CatalogoUsuarios.Repositories;
...
namespace CatalogoOficinas
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IUsuarioRepository, UsuarioSqlServerRepository>();
            services.AddScoped<IEstrelaService, EstrelaService>();
            services.AddScoped<IEstrelaRepository, EstrelaSqlServerRepository>();
